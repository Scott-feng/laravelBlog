    ...
    <div class="x-body">
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="link_name" name="link_name" required="" lay-verify="required"
                           autocomplete="off" value="{{ $link->title }}" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="{{ $link->link }}" id="link_desc" name="link_desc" required=""
                           lay-verify="required"
        ...
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(add)', function (data) {
                ...
                $.ajax({
                    ...
                    type: "PATCH",
                    url: "{{ route('admin_link.update',[$link]) }}",
                    data: {
                        '_token': '{{ csrf_token() }}',
                        'title':$('#link_name').val(),
                        'link':$('#link_desc').val()
