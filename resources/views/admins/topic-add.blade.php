                ...
                <div class="panel-body">
                    ...
                    <form class="layui-form">
                            ...
                            <div class="layui-form-item">
                                <input class="layui-input" type="text" name="title" id="title" value="" placeholder="请填写标题" lay-verify="required">
                            ...
                            <div class="layui-form-item">
                                <div id="editormd_id" class="layui-input">
                                    <textarea name="content" style="display:none;" id="markdown"></textarea>
                                </div>
                            </div>
