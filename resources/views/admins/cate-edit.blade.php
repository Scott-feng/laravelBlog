    ...
    <div class="x-body">
        <form class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="cate_name" name="cate_name" required="" lay-verify="required"
                           autocomplete="off" value="{{ $category->name }}" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="{{ $category->description }}" id="cate_desc" name="cate_desc" required=""
                           lay-verify="required"
        ...
        layui.use(['form', 'layer'], function () {
            ...
            form.on('submit(add)', function (data) {
                ...
                $.ajax({
                    ...
                    type: "PATCH",
                    url: "{{ route('admin_category.update',[$category]) }}",
                    data: {
                        '_token': '{{ csrf_token() }}',
                        'name':$('#cate_name').val(),
